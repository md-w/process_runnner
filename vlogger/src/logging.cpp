...
void RayLog::StartRayLog(const std::string& app_name, RayLogLevel severity_threshold, const std::string& log_dir, bool use_pid)
{
  ...
  if (!log_dir_.empty()) {
    ...
    std::cout << "Log at: " << log_file << std::endl;
    file_logger =
