...
std::string Pipeline::initial_directory{Poco::Path::current()};
void Pipeline::set_initial_directory(const std::string& initial_directory_) { initial_directory = initial_directory_; }
std::string Pipeline::get_initial_directory() { return initial_directory; }

Pipeline::Pipeline(std::string command, std::vector<std::string> args, std::string initial_directory)
...
int Pipeline::get_last_exit_code() { return _last_exit_code; }